...
const kDevices = [
  ...
  // Or16
  {
    ...
    draw: drawOR,
    "devices":[
      {"type":"OR","id":"dev0","x":72,"y":24,"label":""},
      {"type":"OR","id":"dev1","x":72,"y":56,"label":""},
      {"type":"In","id":"dev2","x":16,"y":16,"label":""},
      {"type":"In","id":"dev3","x":24,"y":32,"label":"", inPort:{fill:'#cf0'}},
      {"type":"In","id":"dev4","x":16,"y":48,"label":""},
      {"type":"In","id":"dev5","x":24,"y":64,"label":"", inPort:{fill:'#cf0'}},
      {"type":"In","id":"dev6","x":16,"y":80,"label":""},
      {"type":"OR","id":"dev7","x":72,"y":88,"label":""},
      {"type":"In","id":"dev8","x":24,"y":96,"label":"", inPort:{fill:'#cf0'}},
      {"type":"Out","id":"dev9","x":120,"y":24,"label":""},
      {"type":"Out","id":"dev10","x":120,"y":56,"label":""},
      {"type":"Out","id":"dev11","x":120,"y":88,"label":""},
      {"type":"In","id":"dev12","x":16,"y":112,"label":""},
      {"type":"OR","id":"dev13","x":72,"y":120,"label":""},
      {"type":"In","id":"dev14","x":24,"y":128,"label":"", inPort:{fill:'#cf0'}},
      {"type":"Out","id":"dev15","x":120,"y":120,"label":""},
      {"type":"Out","id":"dev16","x":120,"y":152,"label":""},
      {"type":"In","id":"dev17","x":16,"y":144,"label":""},
      {"type":"In","id":"dev18","x":24,"y":160,"label":"", inPort:{fill:'#cf0'}},
      {"type":"OR","id":"dev19","x":72,"y":152,"label":""},
      {"type":"In","id":"dev20","x":16,"y":176,"label":""},
      {"type":"OR","id":"dev21","x":72,"y":184,"label":""},
      {"type":"In","id":"dev22","x":24,"y":192,"label":"", inPort:{fill:'#cf0'}},
      {"type":"Out","id":"dev23","x":120,"y":184,"label":""},
      {"type":"Out","id":"dev24","x":120,"y":216,"label":""},
      {"type":"OR","id":"dev25","x":72,"y":216,"label":""},
      {"type":"In","id":"dev26","x":16,"y":208,"label":""},
      {"type":"In","id":"dev27","x":24,"y":224,"label":"", inPort:{fill:'#cf0'}},
      {"type":"OR","id":"dev28","x":72,"y":248,"label":""},
      {"type":"In","id":"dev29","x":16,"y":240,"label":""},
      {"type":"In","id":"dev30","x":24,"y":256,"label":"", inPort:{fill:'#cf0'}},
      {"type":"Out","id":"dev31","x":120,"y":248,"label":""},
      {"type":"OR","id":"dev32","x":72,"y":288,"label":""},
      {"type":"OR","id":"dev33","x":72,"y":320,"label":""},
      {"type":"Out","id":"dev34","x":120,"y":288,"label":""},
      {"type":"Out","id":"dev35","x":120,"y":320,"label":""},
      {"type":"In","id":"dev36","x":16,"y":280,"label":""},
      {"type":"In","id":"dev37","x":24,"y":296,"label":"", inPort:{fill:'#cf0'}},
      ...
      {"type":"In","id":"dev50","x":16,"y":504,"label":""},
      {"type":"In","id":"dev51","x":24,"y":520,"label":"", inPort:{fill:'#cf0'}},
      {"type":"OR","id":"dev52","x":72,"y":352,"label":""},
      {"type":"OR","id":"dev53","x":72,"y":384,"label":""},
      {"type":"OR","id":"dev54","x":72,"y":416,"label":""},
      {"type":"OR","id":"dev55","x":72,"y":448,"label":""},
      {"type":"OR","id":"dev56","x":72,"y":480,"label":""},
      {"type":"OR","id":"dev57","x":72,"y":512,"label":""},
      {"type":"Out","id":"dev58","x":120,"y":352,"label":""},
      {"type":"Out","id":"dev59","x":120,"y":384,"label":""},
      {"type":"Out","id":"dev60","x":120,"y":416,"label":""},
      {"type":"Out","id":"dev61","x":120,"y":448,"label":""},
  ...
  // Mux4Way4
  {
    ...
    noRender: true,
    "devices":[
      {"type":"In","id":"dev0","x":24,"y":16,"label":""},
      {"type":"In","id":"dev1","x":32,"y":48,"label":"","inPort":{"fill":"#cf0"}},
      {"type":"In","id":"dev2","x":40,"y":80,"label":"","inPort":{"fill":"#ccf"}},
      {"type":"In","id":"dev3","x":32,"y":176,"label":"","inPort":{"fill":"#cf0"}},
      {"type":"In","id":"dev4","x":24,"y":144,"label":""},
      {"type":"In","id":"dev5","x":40,"y":208,"label":"","inPort":{"fill":"#ccf"}},
      {"type":"Mux4Way1","id":"dev6","x":184,"y":184,"label":"Mux4Way1"},
      {"type":"In","id":"dev7","x":24,"y":272,"label":""},
      {"type":"Mux4Way1","id":"dev8","x":184,"y":312,"label":"Mux4Way1"},
      {"type":"In","id":"dev9","x":32,"y":304,"label":"","inPort":{"fill":"#cf0"}},
      {"type":"In","id":"dev10","x":40,"y":336,"label":"","inPort":{"fill":"#ccf"}},
      {"type":"Out","id":"dev11","x":272,"y":328,"label":""},
      {"type":"In","id":"dev12","x":24,"y":400,"label":""},
      {"type":"In","id":"dev13","x":32,"y":432,"label":"","inPort":{"fill":"#cf0"}},
      {"type":"In","id":"dev14","x":40,"y":464,"label":"","inPort":{"fill":"#ccf"}},
      {"type":"Mux4Way1","id":"dev15","x":184,"y":440,"label":"Mux4Way1"},
      {"type":"Mux4Way1","id":"dev16","x":184,"y":72,"label":"Mux4Way1"},
      {"type":"Out","id":"dev17","x":272,"y":200,"label":""},
      {"type":"Out","id":"dev18","x":272,"y":88,"label":""},
      {"type":"Out","id":"dev19","x":272,"y":456,"label":""},
      {"type":"In","id":"dev20","x":64,"y":552,"label":"sel0","inPort":{"fill":"#fcf"}},
      {"type":"In","id":"dev21","x":64,"y":600,"label":"sel1","inPort":{"fill":"#fcf"}},
      {"type":"In","id":"dev22","x":48,"y":112,"label":"","inPort":{"fill":"#cff"}},
      {"type":"In","id":"dev23","x":48,"y":240,"label":"","inPort":{"fill":"#cff"}},
      {"type":"In","id":"dev24","x":48,"y":368,"label":"","inPort":{"fill":"#cff"}},
      {"type":"In","id":"dev25","x":48,"y":496,"label":"","inPort":{"fill":"#cff"}}
    ],
    "connectors":[
      {"from":"dev6.in0","to":"dev4.out0"},
      {"from":"dev6.in1","to":"dev3.out0"},
      {"from":"dev6.in2","to":"dev5.out0"},
      {"from":"dev6.in3","to":"dev23.out0"},
      {"from":"dev6.in4","to":"dev20.out0"},
      {"from":"dev6.in5","to":"dev21.out0"},
      {"from":"dev8.in0","to":"dev7.out0"},
      {"from":"dev8.in1","to":"dev9.out0"},
      {"from":"dev8.in2","to":"dev10.out0"},
      {"from":"dev8.in3","to":"dev24.out0"},
      {"from":"dev8.in4","to":"dev20.out0"},
      {"from":"dev8.in5","to":"dev21.out0"},
      {"from":"dev11.in0","to":"dev8.out0"},
      {"from":"dev15.in0","to":"dev12.out0"},
      {"from":"dev15.in1","to":"dev13.out0"},
      {"from":"dev15.in2","to":"dev14.out0"},
      {"from":"dev15.in3","to":"dev25.out0"},
      {"from":"dev15.in4","to":"dev20.out0"},
      {"from":"dev15.in5","to":"dev21.out0"},
      {"from":"dev16.in0","to":"dev0.out0"},
      {"from":"dev16.in1","to":"dev1.out0"},
      {"from":"dev16.in2","to":"dev2.out0"},
      {"from":"dev16.in3","to":"dev22.out0"},
      {"from":"dev16.in4","to":"dev20.out0"},
      {"from":"dev16.in5","to":"dev21.out0"},
      {"from":"dev17.in0","to":"dev6.out0"},
  ...
  // CZero16
  {
    ...
    noRender: true,
    "devices":[
      {"type":"In","id":"dev0","x":96,"y":24,"label":"In"},
      {"type":"Toggle","id":"dev1","x":56,"y":24,"label":"Toggle","state":{"on":true}},
      {"type":"Toggle","id":"dev2","x":56,"y":64,"label":"Toggle","state":{"on":true}},
      {"type":"Toggle","id":"dev3","x":56,"y":104,"label":"Toggle","state":{"on":true}},
      {"type":"Toggle","id":"dev4","x":56,"y":144,"label":"Toggle","state":{"on":true}},
      {"type":"In","id":"dev5","x":96,"y":64,"label":"In"},
      {"type":"In","id":"dev6","x":96,"y":104,"label":"In"},
      {"type":"In","id":"dev7","x":96,"y":144,"label":"In"},
      {"type":"DC","id":"dev8","x":16,"y":80,"label":"DC"},
      {"type":"NOT","id":"dev9","x":120,"y":232,"label":"NOT"},
      {"type":"In","id":"dev10","x":80,"y":240,"label":"In"},
      {"type":"Toggle","id":"dev11","x":40,"y":240,"label":"Toggle","state":{"on":true}},
      {"type":"And16","id":"dev12","x":248,"y":16,"label":"And16"},
      {"type":"Out","id":"dev13","x":320,"y":72,"label":"Out"},
      {"type":"Out","id":"dev14","x":320,"y":112,"label":"Out"},
      {"type":"Out","id":"dev15","x":320,"y":152,"label":"Out"},
      {"type":"Out","id":"dev16","x":320,"y":192,"label":"Out"}
    ],
    "connectors":[
      {"from":"dev0.in0","to":"dev1.out0"},
      ...
      {"from":"dev12.in3","to":"dev7.out0"},
      {"from":"dev12.in16","to":"dev9.out0"},
      {"from":"dev12.in17","to":"dev9.out0"},
      {"from":"dev12.in18","to":"dev9.out0"},
      {"from":"dev12.in19","to":"dev9.out0"},
      {"from":"dev12.in20","to":"dev9.out0"},
      {"from":"dev12.in21","to":"dev9.out0"},
      {"from":"dev12.in22","to":"dev9.out0"},
      {"from":"dev12.in23","to":"dev9.out0"},
      {"from":"dev12.in24","to":"dev9.out0"},
      {"from":"dev12.in25","to":"dev9.out0"},
      {"from":"dev12.in26","to":"dev9.out0"},
      {"from":"dev12.in27","to":"dev9.out0"},
      {"from":"dev12.in28","to":"dev9.out0"},
      {"from":"dev12.in29","to":"dev9.out0"},
      {"from":"dev12.in30","to":"dev9.out0"},
      {"from":"dev12.in31","to":"dev9.out0"},
      {"from":"dev13.in0","to":"dev12.out0"},
      {"from":"dev14.in0","to":"dev12.out1"},
      {"from":"dev15.in0","to":"dev12.out2"},
      {"from":"dev16.in0","to":"dev12.out3"}
    ],
  },
  ...
  // ALU
  {
    name: 'ALU',
    "devices":[
      {"type":"DC","id":"dev0","x":0,"y":456,"label":"DC"},
      {"type":"Toggle","id":"dev1","x":48,"y":432,"label":"Toggle","state":{"on":true}},
      {"type":"Toggle","id":"dev2","x":48,"y":384,"label":"Toggle","state":{"on":false}},
      {"type":"Toggle","id":"dev3","x":48,"y":480,"label":"Toggle","state":{"on":true}},
      {"type":"Toggle","id":"dev4","x":48,"y":528,"label":"Toggle","state":{"on":false}},
      {"type":"In","id":"dev5","x":88,"y":384,"label":"x0"},
      {"type":"In","id":"dev6","x":88,"y":432,"label":"x1"},
      {"type":"In","id":"dev7","x":88,"y":480,"label":"x2"},
      {"type":"In","id":"dev8","x":88,"y":528,"label":"x3"},
      {"type":"Toggle","id":"dev9","x":48,"y":296,"label":"Toggle","state":{"on":false}},
      {"type":"In","id":"dev10","x":88,"y":296,"label":"zx"},
      {"type":"And16","id":"dev11","x":184,"y":296,"label":"And16"},
      {"type":"Out","id":"dev12","x":384,"y":416,"label":"Out"},
      {"type":"Out","id":"dev13","x":384,"y":464,"label":"Out"},
      {"type":"Out","id":"dev14","x":384,"y":512,"label":"Out"},
      {"type":"Out","id":"dev15","x":384,"y":560,"label":"Out"},
      {"type":"LED","id":"dev16","x":424,"y":416,"label":"LED"},
      {"type":"LED","id":"dev17","x":424,"y":464,"label":"LED"},
      {"type":"LED","id":"dev18","x":424,"y":512,"label":"LED"},
      {"type":"LED","id":"dev19","x":424,"y":560,"label":"LED"},
      {"type":"NOT","id":"dev20","x":128,"y":296,"label":"NOT"},
      {"type":"Toggle","id":"dev21","x":48,"y":232,"label":"Toggle","state":{"on":false}},
      {"type":"In","id":"dev22","x":88,"y":232,"label":"nx"},
      {"type":"Mux4Way4","id":"dev23","x":304,"y":312,"label":"Mux4Way4"},
      {"type":"Not16","id":"dev24","x":240,"y":200,"label":"Not16"}
    ],
    "connectors":[
      {"from":"dev1.in0","to":"dev0.out0"},
      {"from":"dev2.in0","to":"dev0.out0"},
      ...
      {"from":"dev11.in1","to":"dev20.out0"},
      {"from":"dev11.in2","to":"dev20.out0"},
      {"from":"dev11.in3","to":"dev20.out0"},
      {"from":"dev11.in16","to":"dev5.out0"},
      {"from":"dev11.in17","to":"dev6.out0"},
      {"from":"dev11.in18","to":"dev7.out0"},
      {"from":"dev11.in19","to":"dev8.out0"},
      {"from":"dev12.in0","to":"dev23.out0"},
      {"from":"dev13.in0","to":"dev23.out1"},
      {"from":"dev14.in0","to":"dev23.out2"},
      {"from":"dev15.in0","to":"dev23.out3"},
      ...
      {"from":"dev23.in1","to":"dev24.out1"},
      {"from":"dev23.in2","to":"dev24.out2"},
      {"from":"dev23.in3","to":"dev24.out3"},
      {"from":"dev23.in4","to":"dev11.out0"},
      {"from":"dev23.in5","to":"dev11.out1"},
      {"from":"dev23.in6","to":"dev11.out2"},
      {"from":"dev23.in7","to":"dev11.out3"},
      {"from":"dev23.in16","to":"dev22.out0"},
      {"from":"dev24.in0","to":"dev11.out0"},
      {"from":"dev24.in1","to":"dev11.out1"},
      {"from":"dev24.in2","to":"dev11.out2"},
      {"from":"dev24.in3","to":"dev11.out3"}
    ],
  },
