...
const kDevices = [
  ...
  // Not2
  {
    ...
    height: 100,
    noRender: true,
    // DCに直結させている入力でも、デバイス登録すると無効になってしまうぽい…
    "devices":[
      {"type":"Toggle","id":"dev0","x":72,"y":24,"label":"Toggle","state":{"on":true}},
      {"type":"In","id":"dev1","x":120,"y":24,"label":"In"},
      {"type":"DC","id":"dev2","x":24,"y":48,"label":"DC"},
      {"type":"NAND","id":"dev3","x":168,"y":48,"label":"NAND"},
      {"type":"Out","id":"dev4","x":216,"y":48,"label":"Out"},
      {"type":"LED","id":"dev5","x":264,"y":48,"label":"LED"}
    ],
    "connectors":[
      {"from":"dev0.in0","to":"dev2.out0"},
      {"from":"dev1.in0","to":"dev0.out0"},
  ...
  // Inc16
  {
    ...
    noRender: true,
    "devices":[
      {"type":"In","id":"dev0","x":24,"y":24,"label":""},
      {"type":"In","id":"dev1","x":24,"y":40,"label":""},
      {"type":"In","id":"dev2","x":24,"y":56,"label":""},
      {"type":"In","id":"dev3","x":24,"y":72,"label":""},
      {"type":"In","id":"dev4","x":24,"y":88,"label":""},
      {"type":"In","id":"dev5","x":24,"y":104,"label":""},
      {"type":"In","id":"dev6","x":24,"y":120,"label":""},
      {"type":"In","id":"dev7","x":24,"y":136,"label":""},
      {"type":"In","id":"dev8","x":24,"y":152,"label":""},
      {"type":"In","id":"dev9","x":24,"y":168,"label":""},
      {"type":"In","id":"dev10","x":24,"y":184,"label":""},
      {"type":"In","id":"dev11","x":24,"y":200,"label":""},
      {"type":"In","id":"dev12","x":24,"y":216,"label":""},
      {"type":"In","id":"dev13","x":24,"y":232,"label":""},
      {"type":"In","id":"dev14","x":24,"y":248,"label":""},
      {"type":"In","id":"dev15","x":24,"y":264,"label":""},
      {"type":"DC","id":"dev16","x":24,"y":304,"label":"DC"},
      {"type":"Add16","id":"dev17","x":112,"y":48,"label":"Add16"},
      {"type":"Out","id":"dev18","x":224,"y":24,"label":""},
      {"type":"Out","id":"dev19","x":224,"y":40,"label":""},
      {"type":"Out","id":"dev20","x":224,"y":56,"label":""},
      {"type":"Out","id":"dev21","x":224,"y":72,"label":""},
      {"type":"Out","id":"dev22","x":224,"y":88,"label":""},
      {"type":"Out","id":"dev23","x":224,"y":104,"label":""},
      {"type":"Out","id":"dev24","x":224,"y":120,"label":""},
      {"type":"Out","id":"dev25","x":224,"y":136,"label":""},
      {"type":"Out","id":"dev26","x":224,"y":152,"label":""},
      {"type":"Out","id":"dev27","x":224,"y":168,"label":""},
      {"type":"Out","id":"dev28","x":224,"y":184,"label":""},
      {"type":"Out","id":"dev29","x":224,"y":200,"label":""},
    ...
    "connectors":[
      ...
      {"from":"dev17.in2","to":"dev2.out0"},
      {"from":"dev17.in3","to":"dev3.out0"},
      {"from":"dev17.in4","to":"dev4.out0"},
      {"from":"dev17.in5","to":"dev5.out0"},
      {"from":"dev17.in6","to":"dev6.out0"},
      {"from":"dev17.in7","to":"dev7.out0"},
      {"from":"dev17.in8","to":"dev8.out0"},
      {"from":"dev17.in9","to":"dev9.out0"},
      {"from":"dev17.in10","to":"dev10.out0"},
      {"from":"dev17.in11","to":"dev11.out0"},
      {"from":"dev17.in12","to":"dev12.out0"},
      ...
      {"from":"dev21.in0","to":"dev17.out3"},
      {"from":"dev22.in0","to":"dev17.out4"},
      {"from":"dev23.in0","to":"dev17.out5"},
      {"from":"dev24.in0","to":"dev17.out6"},
      {"from":"dev25.in0","to":"dev17.out7"},
      {"from":"dev26.in0","to":"dev17.out8"},
      {"from":"dev27.in0","to":"dev17.out9"},
      {"from":"dev28.in0","to":"dev17.out10"},
      {"from":"dev29.in0","to":"dev17.out11"},
